...
class ChatScreen extends StatefulWidget {
  ...
  State createState() => ChatScreenState(
      peerId: peerId, peerAvatar: peerAvatar, agentName: agentName);
}
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildInput() {
    return Container(
      ...
      height: 60.0,
      decoration: BoxDecoration(color: Color(0xff101C24)),
    );
  }
